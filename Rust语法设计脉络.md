...
Rust作为一门功能齐全，性能强悍的系统编程语言，自然也不会例外。在这三个方面，Rust做了足够多的思考和提炼，若想简明扼要地完整总结这三大方面，难度较大，我觉得自己掌握的程度也还不够精细，因此这里只简单总结一个方面：核心语法设计。

刚接触Rust的程序员，估计都会有一种感觉：语法花哨繁杂，知识点很多，只比C++简单一点点，学习很吃力，需长时间的琢磨和足够多的练习，才能逐渐熟悉起来。若能找出其语法设计的脉络，并顺着脉络主线向前走，不用强行记忆零零碎碎的大量语法点，就显得尤为重要。这可帮助我们节约许多精力和学习成本、尽快掌握Rust。任何编程语言的设计特点，必然反应其设计者的世界观，以及如何审视现实世界的底层构造。所以我在学习Rust时，喜欢把自己想象成一个编程语言设计者，站在设计者的角度去思考，更有代入感。我所总结的脉络主线如下：
