...
> Rust编译器非常智能，能让编译器做的，尽量不要手动去做，能在编译时确定的事情，尽量不要放在运行时确定。Rust的设计要点，就是尽量和编译器好好沟通，让它尽可能多帮着做一些至关重要的事情。我们可以把Rust编译器想象成一个智能机器人，程序员要做的就是和这个机器人好好说话，用他能听懂的语言告诉他，我们想要做什么，他就会帮我们做什么。

> Rust编译器后期一定会融入人工智能技术，Rust语言或基于Rust的变种语言一定会越来越智能。将Rust的思路发扬光大，走得更远一点，尽可能挖掘、榨干编译器的能力，可让编译器进化为“软件工厂”。Rust编译器可以做的事情
